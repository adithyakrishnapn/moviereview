          ...
          <div className="hidden md:flex items-center space-x-4">
            <div className="relative">
              <input
                ...
                className="bg-gray-800 text-white px-4 py-2 pl-10 rounded-lg border border-gray-700 focus:border-red-500 focus:outline-none focus:ring-2 focus:ring-red-500/20 transition-all"
              />
              <svg
